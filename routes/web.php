...
Route::get('paying', [PayingController::class, 'index'])->name('paying');
Route::post('paying/pay', [PayingController::class, 'pay'])->name('paying.pay');
Route::post('paying/success', [PayingController::class, 'success'])->name('paying.success');
//Route::match(['post', 'get'], 'paying/callback', [PayingController::class, 'callback'])->name('paying.callback');
